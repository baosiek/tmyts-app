...
import { WeekPerformance } from "./week-performance/week-performance";
...
@Component({
  ...
  imports: [TmytsToolbar, MatFormField, MatLabel, MatSelect, MatOption, FormsModule, WeekPerformance, WeekChart, MatDialogModule],
